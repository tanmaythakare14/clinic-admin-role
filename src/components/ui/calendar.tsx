...
function CalendarDropdown({ value, onChange, options = [] }: DropdownProps): React.JSX.Element {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-[60] top-[calc(100%+4px)] left-0 min-w-[110px] bg-white rounded-xl border border-slate-200 shadow-[0_8px_24px_rgba(0,0,0,0.10)] overflow-hidden">
