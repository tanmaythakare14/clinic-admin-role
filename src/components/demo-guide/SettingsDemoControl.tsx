  ...
  return (
    <div className="fixed z-50 flex flex-col bottom-6 left-6 min-w-[210px]">
      ...
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="self-start flex items-center gap-2 px-4 py-2 rounded-full transition-all bg-slate-800 border border-white/10 shadow-[0_4px_16px_rgba(0,0,0,0.3)] text-slate-100 hover:bg-[#273449]"
      >
        <Settings size={13} className="text-violet-400" />
