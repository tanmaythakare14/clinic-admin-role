        ...
        <div className="overflow-hidden rounded-[inherit]">
          ...
          <div className="bg-gradient-to-b from-emerald-50/90 to-white pt-10 pb-6 flex flex-col items-center px-6 text-center">
            ...
            <div className="relative mb-5">
              ...
              <div className="relative w-20 h-20 rounded-full bg-emerald-500 flex items-center justify-center shadow-[0_8px_32px_rgba(16,185,129,0.40)]">
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 lg:px-20 overflow-y-auto bg-stone-50">
        ...
        <div className="flex items-center gap-2.5 mb-8 lg:hidden">
          <div className="flex items-center justify-center rounded-xl bg-primary w-9 h-9 shadow-sm">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-11 text-[14px] font-semibold rounded-lg mt-1 shadow-[0_4px_14px_rgba(13,148,136,0.25)]"
              >
                {isLoading ? (
                  <>
