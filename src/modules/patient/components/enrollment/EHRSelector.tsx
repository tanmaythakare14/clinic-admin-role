...
import type { EnrollmentStep1Values, EnrollmentStep2Values } from '../../@types';
...
export function EHRSelector({ open, onClose, onSelect, selectedEHR }: EHRSelectorProps): React.JSX.Element | null {
  ...
  return (
    <>
      ...
      <div
        className="fixed z-[60] flex flex-col bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.18)] border border-slate-200 overflow-hidden"
        style={{
          width: 280,
          maxHeight: '85vh',
          top: '50%',
