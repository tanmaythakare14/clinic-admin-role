...
function InsuranceSearch({ value, onChange, error }: InsuranceSearchProps): React.JSX.Element {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="absolute z-[200] mt-1.5 w-full rounded-xl border border-slate-200 bg-white shadow-[0_8px_24px_rgba(0,0,0,0.10)] overflow-hidden">
          {filtered.length === 0 ? (
...
export function InsuranceStep({ defaultValues, onBack, onNext }: InsuranceStepProps): React.JSX.Element {
          ...
          <div className="space-y-4">
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <FormItem>
                  <FormLabel className="text-[12px]">Insurance Plan Name</FormLabel>
                  <FormControl>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <FormItem>
                    <FormLabel className="text-[12px]">Plan Type</FormLabel>
                    <FormControl>
                      <PortalSelect
                        value={field.value}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[12px]">Member ID</FormLabel>
                    <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-[12px]">Group Number</FormLabel>
                  <FormControl>
