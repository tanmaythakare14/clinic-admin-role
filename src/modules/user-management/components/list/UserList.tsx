...
export function UserList(): React.JSX.Element {
  ...
  const [users, setUsers] = useState<UserListItem[]>(() => {
    ...
    return secureLocalStorage.getItemObject<UserListItem[]>(USER_LIST_STORAGE_KEY) ?? [];
  });
                  ...
                  return (
                    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      <button
                        ...
                        className="flex items-center gap-1.5 h-7 px-2.5 rounded-md border border-slate-200 text-[11.5px] font-medium text-muted-foreground hover:text-primary hover:border-primary/30 hover:bg-primary/5 transition-colors"
                      >
                        <Send size={11} />
                        Resend Invite
                      </button>
                ...
                return (
                  <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                    <button
                      ...
                      className="w-7 h-7 flex items-center justify-center rounded-md border border-slate-200 text-muted-foreground hover:text-primary hover:border-primary/30 hover:bg-primary/5 transition-colors"
                    >
                      <Pencil size={13} />
                    </button>
                    <button
                      ...
                      className="w-7 h-7 flex items-center justify-center rounded-md border border-slate-200 text-muted-foreground hover:text-amber-600 hover:border-amber-200 hover:bg-amber-50 transition-colors"
                    >
                      <PowerOff size={13} />
                    </button>
                  </div>
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <div ref={typeDropdownRef} className="relative">
                ...
                {typeDropdownOpen && (
                  <div className="absolute left-0 top-[calc(100%+6px)] z-50 w-52 bg-white rounded-xl border border-slate-200 shadow-[0_8px_28px_rgba(0,0,0,0.12)] py-1.5 overflow-hidden">
                    <button
                      type="button"
                      onClick={() => {
                        setTypeFilter('All');
