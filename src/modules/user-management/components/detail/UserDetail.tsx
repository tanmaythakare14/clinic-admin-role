...
import { ArrowLeft, Mail, Phone, Stethoscope, Pencil } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-[#FAFAF9]">
      ...
      >
        ...
        <main className="flex-1 p-7 flex flex-col gap-5">
          ...
          {/* Profile header card */}
          <div className="bg-white rounded-[14px] border border-slate-200 shadow-[0_1px_3px_rgba(0,0,0,0.05)] px-6 py-5">
