...
import { z } from 'zod';
import { Camera, ChevronDown, Eye, EyeOff, Pencil, Trash2 } from 'lucide-react';
...
import type { ClinicProfileFormValues, EhrDetailsFormValues } from '../../@types';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-[14px] border border-slate-200 shadow-[0_1px_3px_rgba(0,0,0,0.05)] overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          <div>
            <h3 className="text-[13.5px] font-bold text-foreground">EHR / EMR Details</h3>
      ...
      <Dialog open={ehrDialogOpen} onOpenChange={setEhrDialogOpen}>
        <DialogContent className="sm:max-w-[480px] p-0 gap-0 overflow-hidden">
          <DialogHeader className="px-6 pt-5 pb-4 border-b border-slate-100">
            <DialogTitle className="text-[14px] font-bold">EHR / EMR Details</DialogTitle>
            <p className="text-[12px] text-muted-foreground mt-0.5">
